...
public class MyProgressBar extends View {
    ...
    public MyProgressBar setCanEndSuccessClickable(boolean isCanEndSuccessClickable){
        this.isTempCanEndSuccessClickable = isCanEndSuccessClickable;
        return this;
    }
    public MyProgressBar setCanReBack(boolean isCanReBack){
     ...
     * @param isCanDrag
     */
    public MyProgressBar setCanDragChangeProgress(boolean isCanDrag){
     ...
     * @param textSize
     */
    public MyProgressBar setTextSize(float textSize) {
     ...
     */
    public MyProgressBar setProgressBarHeight(float progressBarHeight) {
     ...
     */
    public MyProgressBar setTextColorSuccess(int textColorSuccess) {
     ...
     */
    public MyProgressBar setTextColorError(int textColorError) {
     ...
     */
    public MyProgressBar setTextColorNormal(int textColorNormal) {
     ...
     */
    public MyProgressBar setStartDrawable(int startDrawable,BitmapFactory.Options options) {
     ...
     * @return
     */
    public MyProgressBar setEndSuccessDrawable(int endSuccessDrawable,BitmapFactory.Options options) {
        this.endSuccessDrawable = endSuccessDrawable;
        this.optionsEndSuccess = options;
        return this;
    }

    public MyProgressBar setEndSuccessBackgroundColor(int endSuccessBackgroundColor){
     ...
     */
    public MyProgressBar setProgressBarBgColor(int progressBarBgColor) {
     ...
     */
    public MyProgressBar setProgressBarColor(int progressBarColor) {
...
//                    va.cancel();
    ...
    public interface OntextChangeListener{
        //进度变化时调用
        String onProgressTextChange(MyProgressBar specialProgressBarView, int max, int progress);
        //失败
        String onErrorTextChange(MyProgressBar specialProgressBarView, int max, int progress);
        //成功
        String onSuccessTextChange(MyProgressBar specialProgressBarView, int max, int progress);
    }
    /**
     * 动画结束监听
     */
