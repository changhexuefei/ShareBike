...
import com.dcch.sharebike.listener.MyLocationListener;
...
//    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d("gao", "RouteService--------onStartCommand---------------");
...
//        Utils.acquireWakeLock(this);
    ...
    private void initNotification() {
        int icon = R.mipmap.search_center_ic;
    ...
    private void initLocation() {
        mIconLocation = BitmapDescriptorFactory.fromResource(R.mipmap.ease_icon_marka);
...
//        initMarkerClickEvent();
        ...
        mIconLocation = BitmapDescriptorFactory.fromResource(0);
...
//        mBaiduMap.setMyLocationEnabled(true);
    ...
    public void onDestroy() {
        ...
        Log.d("gao", "RouteService----0nDestroy---------------");
        Gson gson = new Gson();
...
//            Log.d("gao", "biginTime--------------" + beginTime);
            Log.d("gao", "totalTime--------------" + totalTime);
            Log.d("gao", "totalDistance--------------" + totalDistance);
